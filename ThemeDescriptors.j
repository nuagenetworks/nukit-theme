...
@implementation NUFlatThemeDescriptor : BKThemeDescriptor
...
+ (CPButton)button
{
    var button = [self makeButton],
        ...
        [
                ...
                [@"text-color",                 NUFlatColorWhite,                   CPThemeStateDefault],
                [@"text-color",                 regularDisabledTextColor,           CPThemeStateDisabled],
                [@"line-break-mode",            CPLineBreakByTruncatingTail],

                [@"bezel-color",                NUFlatColorGrey,                    CPThemeStateBordered],
                [@"bezel-color",                NUFlatColorGreyDark,                [CPThemeStateBordered, CPThemeStateHighlighted]],
                [@"bezel-color",                NUFlatColorGreyLight,               [CPThemeStateBordered, CPThemeStateDisabled]],
                [@"bezel-color",                NUFlatColorBlue,                    [CPThemeStateBordered, CPThemeStateDefault]],
                [@"bezel-color",                NUFlatColorBlueDark,                [CPThemeStateBordered, CPThemeStateDefault, CPThemeStateHighlighted]],
                [@"bezel-color",                NUFlatColorGreyLight,               [CPThemeStateBordered, CPThemeStateDefault, CPThemeStateDisabled]],
...
+ (CPPopUpButton)themedPopUpButton
{
    var button = [[CPPopUpButton alloc] initWithFrame:CGRectMake(0.0, 0.0, 100.0, 21.0) pullsDown:NO],
        ...
        [
            ...
            [@"bezel-color",                NUFlatColorGreyLighter,                 [CPThemeStateBordered, CPThemeStateDisabled]],
            ...
            [@"bezel-color",                NUFlatColorGreyLighter,                 [CPThemeStateControlSizeSmall, CPThemeStateBordered, CPThemeStateDisabled]],
            [@"max-size",                   CGSizeMake(-1.0, 18.0),                 [CPThemeStateControlSizeSmall, CPThemeStateBordered]],
            ...
            [@"bezel-color",                NUFlatColorGreyLighter,                 [CPThemeStateControlSizeMini, CPThemeStateBordered, CPThemeStateDisabled]],
...
+ (CPScrollView)themedScrollView
{
    var scrollView = [[CPScrollView alloc] initWithFrame:CGRectMake(0.0, 0.0, 100.0, 100.0)],
        borderColor = NUFlatColorGreyDark,
...
+ (CPScroller)themedVerticalScroller
{
    var scroller = [self makeVerticalScroller],
        compos = [NUFlatColorGreyDark components],
        ...
        [
                ...
                [@"knob-color",             NUFlatColorGrey,                                [CPThemeStateVertical, CPThemeStateSelected]],
                ...
                // Legacy
                [@"knob-color",             NUFlatColorGrey,                                [CPThemeStateVertical, CPThemeStateScrollViewLegacy, CPThemeStateSelected]],
                [@"knob-color",             NUFlatColorGrey,                                [CPThemeStateVertical, CPThemeStateScrollViewLegacy]],
...
+ (CPScroller)themedHorizontalScroller
{
    var scroller = [self makeHorizontalScroller],
        ...
        [
                ...
                [@"knob-color",             NUFlatColorGrey,                                    CPThemeStateSelected],
                ...
                // Legacy
                [@"knob-color",             NUFlatColorGrey,                                    CPThemeStateScrollViewLegacy],
                [@"knob-color",             NUFlatColorGrey,                                    [CPThemeStateScrollViewLegacy, CPThemeStateSelected]],
...
+ (CPTextField)themedStandardTextField
{
    var textfield = [[CPTextField alloc] initWithFrame:CGRectMake(0.0, 0.0, 160.0, 29.0)],
        ...
        bezelColorError = PatternColor([
            ["textfield-bezel-error-border.png", 1.0, 1.0],
            ["textfield-bezel-error-border.png", 1.0, 1.0],
            ["textfield-bezel-error-border.png", 1.0, 1.0],
            ["textfield-bezel-error-border.png", 1.0, 1.0],
            ["textfield-bezel-middle.png", 1.0, 1.0],
    ...
    [
        ...
        [@"text-color",                 NUFlatColorWhite,                                       CPThemeStateSelectedDataView],
...
+ (CPDatePicker)themedDatePicker
{
    var datePicker = [[CPDatePicker alloc] initWithFrame:CGRectMake(40.0 ,40.0 ,170.0 ,29.0)],
        ...
        themeValues =
        [
            [@"bezel-color",        [CPColor whiteColor],                   CPThemeStateBezeled],
            [@"bezel-color",        [CPColor whiteColor],                   [CPThemeStateBezeled, CPThemeStateDisabled]],
...
+ (CPSegmentedControl)themedSegmentedControl
{
    var segmentedControl = [self makeSegmentedControl],
        ...
        [
                [@"center-segment-bezel-color",     NUFlatColorGrey,       CPThemeStateNormal],
                [@"center-segment-bezel-color",     NUFlatColorGreyLight,  CPThemeStateDisabled],
                [@"center-segment-bezel-color",     NUFlatColorGreyDark,   [CPThemeStateSelected, CPThemeStateDisabled]],
                [@"center-segment-bezel-color",     NUFlatColorBlue,       CPThemeStateSelected],
                [@"center-segment-bezel-color",     NUFlatColorGreyDark,   CPThemeStateHighlighted],
                [@"center-segment-bezel-color",     NUFlatColorBlue,       [CPThemeStateHighlighted, CPThemeStateSelected]],

                [@"divider-bezel-color",            NUFlatColorGrey,       CPThemeStateNormal],
                [@"divider-bezel-color",            NUFlatColorGreyLight,  CPThemeStateDisabled],
                [@"divider-bezel-color",            NUFlatColorGreyDark,   [CPThemeStateSelected, CPThemeStateDisabled]],
                [@"divider-bezel-color",            NUFlatColorBlue,       CPThemeStateSelected],

                [@"left-segment-bezel-color",       NUFlatColorGrey,       CPThemeStateNormal],
                [@"left-segment-bezel-color",       NUFlatColorGreyLight,  CPThemeStateDisabled],
                [@"left-segment-bezel-color",       NUFlatColorGreyDark,   [CPThemeStateSelected, CPThemeStateDisabled]],
                [@"left-segment-bezel-color",       NUFlatColorBlue,       CPThemeStateSelected],
                [@"left-segment-bezel-color",       NUFlatColorGreyDark,   CPThemeStateHighlighted],
                [@"left-segment-bezel-color",       NUFlatColorBlue,       [CPThemeStateHighlighted, CPThemeStateSelected]],
                //
                [@"right-segment-bezel-color",      NUFlatColorGrey,       CPThemeStateNormal],
                [@"right-segment-bezel-color",      NUFlatColorGreyLight,  CPThemeStateDisabled],
                [@"right-segment-bezel-color",      NUFlatColorGreyDark,   [CPThemeStateSelected, CPThemeStateDisabled]],
                [@"right-segment-bezel-color",      NUFlatColorBlue,       CPThemeStateSelected],
                [@"right-segment-bezel-color",      NUFlatColorGreyDark,   CPThemeStateHighlighted],
                [@"right-segment-bezel-color",      NUFlatColorBlue,       [CPThemeStateHighlighted, CPThemeStateSelected]],
...
+ (CPSlider)themedHorizontalSlider
{
    var slider = [self makeHorizontalSlider],
        ...
        [
            [@"track-width", 5.0],
            [@"track-color", NUFlatColorGrey],
            [@"track-color", NUFlatColorGreyLight, CPThemeStateDisabled],

            [@"knob-size",  CGSizeMake(7.0, 7.0)],
            [@"knob-color", NUFlatColorBlue],
            [@"knob-color", NUFlatColorBlueDark,   CPThemeStateHighlighted],
            [@"knob-color", NUFlatColorBlueLight,      CPThemeStateDisabled]
        ];
...
+ (CPButtonBar)themedButtonBar
{
    var buttonBar = [self makeButtonBar],
        ...
        [
            ...
            [@"button-bezel-color",     NUFlatColorGreyLight,  CPThemeStateHighlighted],
...
+ (_CPTableColumnHeaderView)themedColumnHeader
{
    var header = [self makeColumnHeader],
        ...
        [
            [@"background-color",   NUFlatColorGreyLight],
            ...
            [@"background-color",   NUFlatColorGreyLight,      CPThemeStateHighlighted],
            [@"background-color",   NUFlatColorGreyLight,      CPThemeStateSelected],
            [@"background-color",   NUFlatColorGreyLight,      [CPThemeStateHighlighted, CPThemeStateSelected]]
        ];
...
+ (CPTableHeaderView)themedTableHeaderRow
{
    ...
    [header setValue:NUFlatColorGreyLight forThemeAttribute:@"background-color"];
    [header setValue:NUFlatColorGreyLight forThemeAttribute:@"divider-color"];
...
+ (_CPCornerView)themedCornerview
{
    ...
    [corner setValue:NUFlatColorGreyLight forThemeAttribute:"background-color"];
    [corner setValue:NUFlatColorGreyLight forThemeAttribute:"divider-color"];
...
+ (CPTableView)themedTableView
{
    ...
    var tableview = [[CPTableView alloc] initWithFrame:CGRectMake(0.0, 0.0, 150.0, 150.0)],
        ...
        [
            ...
            [@"selection-color",                        NUFlatColorBlue],
            ...
            [@"dropview-above-border-color",            NUFlatColorBlueDark],
            [@"dropview-above-border-width",            4.0],

            [@"dropview-above-selected-border-color",   NUFlatColorBlueDark],
...
+ (CPSplitView)themedSplitView
{
    ...
    var themedSplitViewValues =
        [
            ...
            [@"pane-divider-color", NUFlatColorGreyLight],
...
+ (CPRuleEditor)themedRuleEditor
{
    var ruleEditor                  = [[CPRuleEditor alloc] initWithFrame:CGRectMake(0.0, 0.0, 400.0, 300.0)],
        backgroundColors           = [NUFlatColorWhite, NUFlatColorWhite],
        selectedActiveRowColor     = NUFlatColorWhite,
        selectedInactiveRowColor   = NUFlatColorWhite,
        sliceTopBorderColor        = NUFlatColorGreyLighter,
        sliceBottomBorderColor     = NUFlatColorGreyLighter,
        sliceLastBottomBorderColor = NUFlatColorWhite,
...
+ (_CPToolTipWindowView)themedTooltip
{
    var toolTipView = [[_CPToolTipWindowView alloc] initWithFrame:CGRectMake(0.0, 0.0, 200.0, 100.0) styleMask:_CPToolTipWindowMask],
        ...
        themeValues =
        [
            [@"stroke-color",       NUFlatColorGreyDark],
            [@"stroke-width",       1.0],
            [@"border-radius",      0.0],
            [@"background-color",   NUFlatColorGreyLight],
...
+ (CPBox)themedBox
{
    var box = [[CPBox alloc] initWithFrame:CGRectMake(0, 0, 100, 100)],
        ...
        themeValues =
        [
            [@"background-color", NUFlatColorGreyLighter],
            [@"border-width", 1.0],
            [@"border-color", NUFlatColorGreyLight],
            [@"corner-radius", 3.0],
...
+ (_CPModalWindowView)themedModalWindowView
{
    var modalWindowView = [[_CPModalWindowView alloc] initWithFrame:CGRectMake(0, 0, 200, 200) styleMask:_CPModalWindowView],
        ...
        themeValues =
        [
            [@"bezel-color", NUFlatColorWindowBody]
        ];
...
+ (_CPStandardWindowView)themedStandardWindowView
{
    var standardWindowView = [[_CPStandardWindowView alloc] initWithFrame:CGRectMake(0, 0, 200, 200) styleMask:CPClosableWindowMask],
        ...
        [
            ...
            [@"bezel-head-color",           NUFlatColorWindowBody, CPThemeStateNormal],
            [@"bezel-head-color",           NUFlatColorWindowBody, CPThemeStateKeyWindow],
            [@"bezel-head-color",           NUFlatColorWindowBody, CPThemeStateMainWindow],
            [@"bezel-head-sheet-color",     NUFlatColorWindowBody],
            [@"solid-color",                NUFlatColorWindowBody],

            [@"title-font",                 [CPFont systemFontOfSize:CPFontCurrentSystemSize]],
            [@"title-text-color",           NUFlatColorGrey],
            [@"title-text-color",           NUFlatColorBlue, CPThemeStateKeyWindow],
            [@"title-text-color",           NUFlatColorBlue, CPThemeStateMainWindow],
            [@"title-text-shadow-color",    [CPColor whiteColor]],
            [@"title-text-shadow-offset",   CGSizeMakeZero()],
            ...
            [@"divider-color",              NUFlatColorGreyLighter],
            [@"body-color",                 NUFlatColorWindowBody],
            [@"title-bar-height",           31],
...
+ (_CPBorderlessBridgeWindowView)themedBorderlessBridgeWindowView
{
    var bordelessBridgeWindowView = [[_CPBorderlessBridgeWindowView alloc] initWithFrame:CGRectMake(0,0,0,0)],
        ...
        themeValues =
        [
            [@"toolbar-background-color", NUFlatColorGreyLight]
        ];
...
+ (_CPToolbarView)themedToolbarView
{
    var toolbarView = [[_CPToolbarView alloc] initWithFrame:CGRectMake(0.0, 0.0, 100.0, 59.0)],
        ...
        [
            ...
            [@"image-item-separator-color",             NUFlatColorGreyDark],
...
+ (_CPMenuItemStandardView)themedMenuItemStandardView
{
    var menuItemStandardView = [[_CPMenuItemStandardView alloc] initWithFrame:CGRectMake(0.0, 0.0, 16.0, 16.0)],
        ...
        [
            ...
            [@"menu-item-selection-color",                                  NUFlatColorBlue],
...
+ (_CPMenuView)themedMenuView
{
    var menuView = [[_CPMenuView alloc] initWithFrame:CGRectMake(0.0, 0.0, 200.0, 100.0)],
        ...
        [
            ...
            [@"menu-bar-window-background-color",                   NUFlatColorGreyLight],
            [@"menu-bar-window-background-selected-color",          NUFlatColorBlue],
            ...
            [@"menu-bar-highlight-color",                           NUFlatColorBlue],
...
+ (CPProgressIndicator)themedBarProgressIndicator
{
    ...
    var themedProgressIndicator = [
        [@"bezel-color", NUFlatColorGrey],
        [@"bar-color", NUFlatColorBlue],
        [@"default-height", 12]];
...
+ (_CPTokenFieldToken)themedTokenFieldToken
{
    var token = [[_CPTokenFieldToken alloc] initWithFrame:CGRectMake(0.0, 0.0, 60.0, 19.0)],
        ...
        bezelColor = NUFlatColorBlue,

        themeValues =
        [
            [@"bezel-color",    NUFlatColorBlue,                    CPThemeStateBezeled],
            [@"bezel-color",    NUFlatColorBlueLight,               [CPThemeStateBezeled, CPThemeStateHighlighted]],
            [@"bezel-color",    NUFlatColorGrey,                    [CPThemeStateBezeled, CPThemeStateDisabled]],

            [@"text-color",     NUFlatColorWhite],
            [@"text-color",     NUFlatColorWhite,                   CPThemeStateHighlighted],
            [@"text-color",     NUFlatColorBlack,                   CPThemeStateDisabled],
...
+ (CPProgressIndicator)themedCircularProgressIndicator
{
    ...
    var themeValues =
        [
            [@"circular-border-color", NUFlatColorBlue],
            [@"circular-border-size", 1],
            [@"circular-color", NUFlatColorBlue]
        ];
